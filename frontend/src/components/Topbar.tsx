...
export default function Topbar() {
  ...
  const profileMenuItems = [
    { id: 'profile', label: 'Your Profile', path: '/profile', icon: '👤' },
    { id: 'settings', label: 'Settings', path: '/settings', icon: '⚙️' },
  ...
  return (
    <>
      {/* Topbar */}
      <div className="fixed h-20 top-0 left-0 right-0 bg-slate-800/90 backdrop-blur-xl border-b border-purple-500/20 z-50">
      ...
      {isMobileMenuOpen && (
        <div
          className="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 lg:hidden mt-16"
