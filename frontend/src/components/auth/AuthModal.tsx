...
import { completeProfile, loginUser, registerUser, verifyOtp } from '../../api/auth';
import { removeToken, setToken } from '../../utils/cookieHelper';
...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
    ...
    const handleSignIn = async () => {
        if (!formData.email || !formData.password) return alert("Enter credentials");
        try {
            setLoading(true);
                ...
                <div className="p-6">
                    {step === 'choice' && (
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-gray-900 text-center mb-2">Welcome to Dribbble</h2>
                            <p className="text-gray-600 text-center mb-6">Sign up or sign in to continue</p>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="text-sm text-pink-500 hover:text-pink-600">Forgot password?</button>
                                </div>
                    ...
                    {step === 'otp' && (
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">We sent a code to {formData.email}</p>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className={`w-full py-3 bg-pink-500 text-white rounded-lg font-semibold hover:bg-pink-600 transition-colors mt-6 ${loading ? 'opacity-70 cursor-not-allowed' : ''
                                        }`}
                                >
                    ...
                    {step === 'success' && (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-600 mb-6">Welcome to Dribbble, {formData.name || 'there'}!</p>
