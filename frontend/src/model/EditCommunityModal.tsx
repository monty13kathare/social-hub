    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-slate-900 rounded-2xl border border-slate-700/50 w-full max-w-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full bg-slate-700/50 border border-slate-600 rounded-lg py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
                <option value="" className='option-dark'>Select a category</option>
                {mainCategories.map(category => (
                  <option key={category.id} value={category.id} className='option-dark'>
                    {category.name}
                  </option>
                ))}
              </select>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {[
                ...
                { value: 'restricted', label: 'Restricted', desc: 'Approve to post' },
          ...
          {/* Banner Color */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">Banner Color</h3>
