// components/CommunityActionModal.tsx
import { useState } from 'react';
import type { Community, ModalType } from '../types/types';
...
export const CommunityActionModal: React.FC<CommunityActionModalProps> = ({
    ...
    const actionColor = isJoin ? 'from-purple-600 to-pink-600' : 'from-red-600 to-orange-600';
    const actionHoverColor = isJoin ? 'from-purple-500 to-pink-500' : 'from-red-500 to-orange-500';
    const icon = isJoin ? '👋' : '🚪';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : `An error occurred while ${type}ing the community`);
        }
    };
