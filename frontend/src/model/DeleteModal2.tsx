...
const DeleteModal2: React.FC<DeleteModalProps> = ({
  ...
  const finalRequiresConfirmation = requiresConfirmation || defaultContent.requiresConfirmation || false;
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            disabled={isLoading || (finalRequiresConfirmation && deleteConfirm !== confirmationText)}
