                                ...
                                <div className="flex justify-between gap-2">
                                    {formData.otp.map((digit, index) => (
                                        <input
                                            ...
                                            className="w-full aspect-square text-center text-2xl font-bold border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 outline-none"
                                        />
                                    ))}
                                </div>
                                ...
                                <div className="flex justify-center mb-4">
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className="absolute bottom-0 right-0 bg-white border border-gray-300 rounded-full p-2 cursor-pointer"
                                        >
