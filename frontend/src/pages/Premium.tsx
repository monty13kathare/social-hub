...
export default function Premium() {
    ...
    const pricingPlans: PricingPlan[] = [
        {
            ...
            period: billingPeriod === 'yearly' ? 'per month, billed yearly' : 'per month',
    ...
    const savings = billingPeriod === 'yearly' ? 'Save up to 25%' : '';
            ...
            <div className="bg-linear-to-r from-purple-900/50 to-pink-900/50 border-b border-slate-700/50">
                <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                        Upgrade Your
                        <span className="bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Experience</span>
                    </h1>
                    <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-8">
                        Unlock powerful features, support our platform, and take your social experience to the next level.
                    </p>
                </div>
            </div>
            ...
            <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="bg-slate-800/50 rounded-2xl p-2 border border-slate-700/50">
                        <div className="flex items-center space-x-4">
                            <button
                                ...
                                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${billingPeriod === 'monthly'
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${billingPeriod === 'yearly'
                                    ? 'bg-slate-700 text-white'
                                    : 'text-slate-400 hover:text-white'
                                    }`}
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {pricingPlans.map((plan) => (
                        <div
                            key={plan.id}
                            className={`relative bg-slate-800/50 rounded-3xl border-2 transition-all duration-300 hover:scale-105 hover:shadow-2xl ${plan.popular
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    {billingPeriod === 'yearly' && plan.id === 'pro' && (
                                        <p className="text-green-400 text-sm mt-1">Save $24 annually</p>
                                    )}
                                </div>
                ...
                <div className="bg-slate-800/30 rounded-3xl border border-slate-700/50 p-8 md:p-12">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-white mb-4">
                            Premium <span className="bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Benefits</span>
                        </h2>
                        ...
                        {[
                            {
                                ...
                                description: 'Enjoy SocialHub without any advertisements interrupting your flow.'
                            },
                            {
                                icon: '🎨',
                                title: 'Custom Themes',
                                description: 'Personalize your interface with custom color schemes and dark modes.'
                            },
                            {
                                icon: '🛡️',
                                title: 'Enhanced Privacy',
                                description: 'Take control of your privacy with advanced settings and controls.'
                            },
                            {
                                icon: '📊',
                                title: 'Advanced Analytics',
                                description: 'Get detailed insights into your content performance and audience.'
                            },
                            {
                                icon: '⚡',
                            ...
                            },
                            {
                                ...
                                description: 'Stand out with special badges that show your premium status.'
                            }
                        ].map((feature, index) => (
                            <div
                                key={index}
                        ...
                        {[
                            {
                                ...
                                answer: 'Yes, you can cancel your premium subscription at any time. Your benefits will remain active until the end of your billing period.'
                            },
                            {
                                question: 'Is there a free trial?',
                                answer: 'We offer a 7-day free trial for all premium plans. No credit card required to start the trial.'
                            },
                            {
