          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
            <div className="flex items-start space-x-4 mb-4 lg:mb-0">
              <button
                ...
                className="p-2 text-white hover:bg-white/20 rounded-lg transition-all duration-200 mt-1"
              >
                ← Back
              </button>
              <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center text-white font-bold text-3xl backdrop-blur-sm border border-white/30">
                    ...
                    <div className="flex items-center space-x-4 p-4 bg-slate-800/30 rounded-xl border border-slate-700/50">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <span className="px-2 py-1 text-xs rounded-lg border bg-purple-500/20 text-purple-400 border-purple-500/30">
                            Creator
                          </span>
                        </div>
